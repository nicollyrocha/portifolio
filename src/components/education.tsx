      ...
      {language === "BR" && (
        <>
          ...
          <div className="flex flex-wrap w-fit">
            • Graduação em Sistemas de Informação - Estácio de Sá (03/2018 -
            12/2022)
          </div>
          <div>
      ...
      {language === "US" && (
        <>
          ...
          <div className="flex flex-wrap">
            • Undergraduate course in Information Systems – Estácio de Sá
            (03/2018 - 12/2022)
          </div>
          <div>
            • Post-graduate course in Software Engineering - PUC Minas (11/2023
            - 05/2025)
          </div>
        </>
      )}
